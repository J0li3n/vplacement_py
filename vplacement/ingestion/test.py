...
# Creating an object
recipe = Spoonacular("https://www.ricardocuisine.com/en/recipes/5762-classic-beef-chili", allergies='yellow onion')
...
print(recipe.output_recipes_veg[0]['missedIngredients'])

#recipe.remove_allergies()

#print(len(recipe.output_recipes_veg['output_recipes']))
